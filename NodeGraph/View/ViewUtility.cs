...
{
	// Utility Script Copied from: https://github.com/lifeisforu/NodeGraph/blob/master/View/ViewUtil.cs
	...
	public class ViewUtility
    {
		...
		public static PortView FindNodePortView<T>(FrameworkElement rootVisual, Guid guid, string portName) where T : PortView
		{
			...
			{
				PortViewModel portVM = portView.DataContext as PortViewModel;
